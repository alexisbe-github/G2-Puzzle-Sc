...
public class VueJeuMultiCoop extends Stage{
	...
	public VueJeuMultiCoop(int taille, int numJoueur, Joueur joueur,
        ...
        JeuMultiCoopControleur controller = new JeuMultiCoopControleur(this, taille, numJoueur, joueur,
